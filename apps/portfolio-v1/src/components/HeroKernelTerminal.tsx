    ...
    <div className="hero-kernel-wrapper">
      ...
      <div className="kernel-monogram-bar">
        <svg className="dmt-monogram-svg" viewBox="0 0 160 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="56" y="28" fill="#ffffff" fontFamily="Outfit, sans-serif" fontSize="18" fontWeight="800" letterSpacing="2">
            DMT
          </text>
          <text x="56" y="40" fill="var(--accent-cyan)" fontFamily="JetBrains Mono, monospace" fontSize="7.5" letterSpacing="1.5">
            SOFTWARE CORE
          </text>
        </svg>
        ...
        <div className="kernel-live-pulse">
          ...
          <span className="live-pulse-text">SYSTEM KERNEL: ONLINE</span>
        </div>
      </div>

      {/* Ventana de Terminal de Ingeniería */}
      <div className="terminal-window">
        {/* Barra superior de la ventana */}
        <div className="terminal-header">
          <div className="terminal-traffic-lights" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#22c55e', display: 'inline-block' }} />
            <span style={{ fontSize: '0.72rem', color: '#94a3b8', fontFamily: 'JetBrains Mono, monospace' }}>STATUS: OK</span>
          </div>
          <div className="terminal-title">
            <FiTerminal size={13} style={{ color: 'var(--accent-cyan)' }} />
            <span>dmt@systems-terminal:~</span>
          </div>
        ...
        <div className="terminal-actions-bar" role="tablist" aria-label="Terminal inspector commands">
          <button
            type="button"
            role="tab"
            aria-selected={activeCmdKey === 'sys --inspect'}
          ...
          <button
            type="button"
            role="tab"
            aria-selected={activeCmdKey === 'icpc --stats'}
          ...
          <button
            type="button"
            role="tab"
            aria-selected={activeCmdKey === 'ai --agents'}
          ...
          <button
            type="button"
            role="tab"
            aria-selected={activeCmdKey === 'arch --validate'}
        ...
        <div className="terminal-screen">
          ...
          <div className="terminal-output-body" role="tabpanel" aria-live="polite">
