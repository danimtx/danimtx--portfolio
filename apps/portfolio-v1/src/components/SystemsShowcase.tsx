    ...
    <div className="systems-showcase-wrapper">
      ...
      <div className="systems-controls-bar">
        ...
        <div className="systems-search-box">
          <input
            type="text"
            aria-label={lang === 'en' ? "Search tech stack or systems" : "Filtrar por tecnología o sistemas"}
          ...
          {searchQuery && (
            <button
              ...
              aria-label={lang === 'en' ? "Clear search query" : "Limpiar búsqueda"}
            >
              ✕
            </button>
          )}
            ...
            <article key={project.id} className="system-blueprint-card gsap-reveal">
              ...
              <div className="system-card-body">
                <h3
                  ...
                  tabIndex={0}
                  onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') onOpenProjectDetails(project); }}
                  aria-label={lang === 'en' ? `Open ${project.title} details` : `Abrir detalles de ${project.title}`}
                >
                  {project.title}
                </h3>
                ...
                {project.architectureHighlight && (
                  <div className="system-arch-pill">
                    <FaShieldAlt size={12} style={{ color: 'var(--accent-cyan)', flexShrink: 0 }} />
                ...
                <div className="system-actions-footer">
                  ...
                  <button
                    ...
                    aria-label={lang === 'en' ? `Open case study for ${project.title}` : `Ver caso de estudio de ${project.title}`}
                  >
                    <FiImage size={14} />
                    <span>{lang === 'en' ? 'Case Study' : 'Caso de Estudio'}</span>
                  </button>
