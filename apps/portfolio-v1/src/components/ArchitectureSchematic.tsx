          ...
          <div className="arch-svg-container">
            <svg viewBox="0 0 400 400" className="arch-svg" aria-label="Diagrama de capas concéntricas de Clean Architecture">
              ...
              <circle
                ...
                role="button"
                tabIndex={0}
                aria-label={lang === 'en' ? "Select Frameworks and Drivers layer" : "Seleccionar capa Frameworks y Drivers"}
                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setSelectedLayerIndex(0); } }}
              ...
              <circle
                ...
                role="button"
                tabIndex={0}
                aria-label={lang === 'en' ? "Select Interface Adapters layer" : "Seleccionar capa Interface Adapters"}
                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setSelectedLayerIndex(1); } }}
                style={{ cursor: 'pointer' }}
              />
              <circle
                cx="200" cy="200" r="90"
                ...
                role="button"
                tabIndex={0}
                aria-label={lang === 'en' ? "Select Use Cases Application Core layer" : "Seleccionar capa Use Cases Application Core"}
                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setSelectedLayerIndex(2); } }}
                style={{ cursor: 'pointer' }}
              />
              <circle
                cx="200" cy="200" r="48"
                ...
                role="button"
                tabIndex={0}
                aria-label={lang === 'en' ? "Select Domain Core layer" : "Seleccionar capa Domain Core"}
                onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setSelectedLayerIndex(3); } }}
                style={{ cursor: 'pointer' }}
              />
