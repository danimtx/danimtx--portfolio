...
export default function CyberMatrixBackground() {
  ...
  useEffect(() => {
    ...
    const updateGradient = () => {
      ...
      bgGradient.addColorStop(0, 'rgba(56, 189, 248, 0.025)');
      bgGradient.addColorStop(0.5, 'rgba(129, 140, 248, 0.015)');
      bgGradient.addColorStop(1, 'rgba(8, 9, 13, 0)');
    };
    ...
    const colors = ['#38bdf8', '#818cf8', '#64748b', '#f59e0b'];
