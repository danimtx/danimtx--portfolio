...
function ProjectFullScreen({ project, onClose }: { project: Project; onClose: () => void }) {
  ...
  return (
    <div
      ...
      style={{ position: 'absolute', top: 0, left: 0, width: '100%', minHeight: '100vh', background: '#08090d', zIndex: 100 }}
    >
      {/* Hero Header */}
      ...
      {selectedImage && createPortal(
        ...
        >
          ...
          <img
            ...
            style={{ maxWidth: '95vw', maxHeight: '95vh', objectFit: 'contain', display: 'block', margin: 'auto', transform: `translateX(${dragOffset}px)`, transition: dragOffset === 0 ? 'transform 0.35s cubic-bezier(0.16, 1, 0.3, 1)' : 'none' }}
          />
        </div>,
        document.body
      )}
